      ...
      {items.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            >
              <h3
                className={`flex-1 pr-4 transition-colors duration-300 ${
                  isOpen
              ...
              <div
                className={`shrink-0 w-8 h-8 flex items-center justify-center rounded-lg transition-all duration-500 ${
                  isOpen
