...
export function CommandPalette() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[10vh] sm:pt-[15vh] px-4" role="dialog" aria-modal="true" aria-label="Command palette">
      <div
      ...
      <div className="relative w-full max-w-lg">
        ...
        >
          ...
          <div id="command-list" className="max-h-[60vh] sm:max-h-[50vh] overflow-y-auto py-2" role="listbox">
