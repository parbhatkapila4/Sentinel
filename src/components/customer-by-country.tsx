      ...
      >
        {isLoading ? (
          ...
          <>
            ...
            {dotsWithCoords.length > 0 && (
              <>
                <div
                  className="absolute top-6 left-6 bg-[#141414]/90 backdrop-blur-sm border border-white/[0.07] rounded-xl px-4 py-3 shadow-xl z-10 ring-1 ring-white/[0.04]"
                  style={{
                    boxShadow: `0 0 24px ${ROYAL_GREEN_SOFT}, 0 4px 24px rgba(0,0,0,0.4)`,
                  }}
                >
                  <p className="text-[10px] font-semibold text-white/50 uppercase tracking-[0.15em] mb-0.5">
                    Total deals
                  </p>
                  <p
                    className="text-2xl font-bold tabular-nums animate-pulse-soft"
                    style={{
                      color: ROYAL_GREEN,
                      textShadow: `0 0 20px ${ROYAL_GREEN_SOFT}`,
                    }}
                  >
                  ...
                  {dotsWithCoords.length > 0 && (
                    <div className="flex items-center gap-1.5 mt-2">
                      <div
                        ...
                        style={{
                          backgroundColor: ROYAL_GREEN,
                          boxShadow: `0 0 8px ${ROYAL_GREEN_GLOW}`,
                        }}
                      />
                      <span className="text-[10px] font-medium uppercase tracking-wider" style={{ color: ROYAL_GREEN_GLOW }}>
                ...
                <div
                  className="absolute bottom-6 left-6 bg-[#141414]/90 backdrop-blur-sm border border-white/[0.07] rounded-xl p-4 shadow-xl z-10 min-w-[180px] ring-1 ring-white/[0.04]"
                  style={{ boxShadow: "0 4px 24px rgba(0,0,0,0.4)" }}
                >
                  <h4 className="text-sm font-semibold text-white mb-3">
                    Top 3 {top3Countries.length === 1 ? "Country" : "Countries"}
                  </h4>
                  <div className="mt-4 space-y-2">
                    {top3Countries.map((item, index) => (
